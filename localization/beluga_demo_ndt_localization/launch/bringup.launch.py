...
def generate_launch_description():
    print("generating launch desc")
    pkg_dir = get_package_share_directory("beluga_demo_ndt_localization")
    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument(
                ...
                default_value="magazino_hallway",
            ),
            DeclareLaunchArgument(
                ...
                default_value="default_ndt_3d.ros2.yaml",
            ),
            Node(
                package="beluga_amcl",
                ...
                parameters=[
                    ...
                    {'map_path': '/home/adminuser/ws/src/beluga/points.hdf5'},
                ],
            ),
            Node(
